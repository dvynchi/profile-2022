...
const highlightMenu = () => 
{
    ...
    const contactMenu = document.querySelector('#projects-page')
...
/* code to CLOSE HAMBURGER MENU when a selection is made */
...
//trigger hideMobileMenu function
hamLinks.addEventListener('click', hideMobileMenu);
hamLinks.addEventListener('click', hideMobileMenu);
